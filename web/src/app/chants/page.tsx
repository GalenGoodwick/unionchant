            ...
            {activeSubspaceId?.startsWith('podiumchat:') && dockedPodium ? (
              ...
              <>
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  <ShareMenu url={`/podium/${dockedPodium.id}`} text={dockedPodium.title} variant="icon" />
                </div>
              </>
              ...
              <>
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  <ShareMenu url={`/groups/${dockedGroup.slug}`} text={dockedGroup.name} variant="icon" />
                </div>
              </>
            ) : activeSubspaceId ? (
              /* IDEA SUBSPACE state */
              <>
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  {detail && (
                    <ShareMenu url={`/chants/${detail.id}`} text={detail.question} variant="icon" />
                  )}
                </div>
              </>
              ...
              <>
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  <ShareMenu url={`/chants/${dockedChant?.id || dockedPostId}`} text={dockedChant?.question || detail?.question || ''} variant="icon" />
                      ...
                      return (
                        <div key={p.id} className="flex items-start gap-2.5 px-3 py-2.5 hover:bg-surface/30 transition-colors cursor-pointer" onClick={() => handleDock(`podium:${p.id}`)}>
                          ...
                          <div className="relative pt-1 self-center flex items-center gap-2">
                            ...
                            <ShareMenu url={`/podium/${p.id}`} text={p.title} variant="icon" />
                            <div className="relative">
                            <DropCircle
                              id={`podium:${p.id}`}
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="relative z-10 pt-1 self-center flex items-center gap-2">
                                ...
                                <ShareMenu url={`/chants/${d.id}`} text={d.question} variant="icon" />
                                <div className="relative">
                                  <DropCircle
                                    id={d.id}
                    ...
                    {filteredGroups.map(g => {
                      ...
                      return (
                        <div key={g.id} className="flex items-start gap-2.5 px-3 py-2.5 hover:bg-surface/30 transition-colors cursor-pointer" onClick={() => handleDock(`group:${g.slug}`)}>
                          ...
                          <div className="relative pt-1 self-center flex items-center gap-2">
                            <ShareMenu url={`/groups/${g.slug}`} text={g.name} variant="icon" />
                            <div className="relative">
                            <DropCircle
                              id={`group:${g.slug}`}
                    ...
                    {!isDocked && (() => {
                      ...
                      return (
                        <div className="relative z-10 pt-1 self-center flex items-center gap-2">
                          ...
                          <ShareMenu url={`/chants/${chant.id}`} text={chant.question} variant="icon" />
                          <div className="relative">
                            <DropCircle
                              id={chant.id}
                              isActive={isNearDrop}
                        ...
                        {!detailLoading && detail && manageMode && chant.isCreator && (
                          <div>
                            ...
                            <div className="grid grid-cols-2 gap-1.5">
                              ...
                              <ShareMenu url={`/chants/${chant.id}`} text={chant.question} />
