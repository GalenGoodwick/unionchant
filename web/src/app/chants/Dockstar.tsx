...
interface DropCircleProps {
  ...
  icon?: 'chat' | 'chant' | 'document' | 'people' | 'default'
}
    ...
    <div className="relative shrink-0">
      ...
      >
        {(() => {
          ...
          // Chant marker: a two-bubble "collective conversation" speech bubble
          // (Heroicons chat-bubble-left-right). Deliberately distinct from the
          // subchat's single oval-with-dots 'chat' bubble above.
          if (icon === 'chant') return (
            <svg className={strokeCls} viewBox="0 0 24 24" strokeWidth={1.6} style={strokeStyle}>
