    ...
    <div className="min-h-screen bg-surface">
      ...
      <div className="max-w-xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="bg-background rounded-lg border border-border p-6">
          <h1 className="text-xl sm:text-2xl font-bold text-foreground mb-6">Start a New Chant</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              />
              <p className="text-muted-light text-sm mt-1">Help others find your chant</p>
            </div>
            ...
            {showAdvanced && (
              <div className="space-y-5 border border-border rounded-lg p-4 bg-surface">
                <p className="text-sm text-muted mb-4">Most chants work great with the defaults. Only customize if you need specific timing or behavior.</p>
                ...
                <div>
                  <label className="block text-foreground font-medium text-sm mb-1">
                    ...
                    <span className="ml-2 text-xs text-muted font-normal">(Recommended: Chant ends)</span>
                  </label>
