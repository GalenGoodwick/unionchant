...
export default function MethodologyClient() {
  ...
  return (
    <FrameLayout showBack hideFooter
      footerRight={
        <button
          onClick={() => router.push(session ? '/chants' : '/')}
          className="px-4 py-2 text-sm font-medium text-accent hover:text-accent-hover transition-colors"
        >
          {session ? 'Back to Chants' : 'Back to Home'}
        </button>
      }
    >
      <div className="py-6">
          ...
          <div className="bg-surface rounded-xl border border-border p-6 space-y-4">
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-sm text-subtle leading-relaxed">
                  The top idea in each cell advances to the next tier. Ideas with fewer votes don&apos;t advance. Winners compete
