    ...
    <div className="min-h-screen bg-surface">
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="bg-background rounded-lg border border-border p-6">
          <h1 className="text-xl sm:text-2xl font-bold text-foreground mb-6">Create a Community</h1>
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="flex-1 bg-surface border border-border rounded-lg px-4 py-3 text-foreground placeholder-muted-light focus:outline-none focus:border-accent font-mono text-sm"
                  value={formData.slug}
              ...
              <div className="space-y-3">
                <label className={`flex items-start gap-3 p-3 border rounded-lg cursor-pointer transition-colors ${
                  ...
                  <div>
                    ...
                    <div className="text-muted text-sm">Anyone can find and join this community</div>
                  </div>
                </label>
