    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-900 to-slate-800">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <article className="prose prose-invert prose-lg max-w-none">
          <h1 className="text-4xl font-bold text-white mb-2">Union Chant</h1>
          <p className="text-xl text-slate-300 mb-12">Collective Decision-Making for the Modern Age</p>

          <hr className="border-slate-700 my-8" />

          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-white mb-4">The Problem We All Feel</h2>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-white mb-4">Why This Matters Now</h2>
            <p className="text-slate-300 leading-relaxed mb-4">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-white mb-4">A Simple Idea: Small Groups, Big Decisions</h2>
            <p className="text-slate-300 leading-relaxed mb-4">
            ...
            <p className="text-slate-300 leading-relaxed font-medium text-white">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-white mb-4">Why This Works</h2>
            <p className="text-slate-300 leading-relaxed mb-4">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-white mb-4">Decisions That Evolve</h2>
            <p className="text-slate-300 leading-relaxed mb-4">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-white mb-4">What Union Chant Is Not</h2>
            <p className="text-slate-300 leading-relaxed mb-4">
          ...
          <section className="mb-12">
            ...
            <p className="text-slate-300 leading-relaxed mb-4">
              <strong className="text-white">In organizations,</strong> important decisions are often shaped by who is present or who speaks most confidently. Union Chant allows contributions from across roles and seniority levels. Small group deliberation means the mailroom clerk's brilliant insight gets the same fair hearing as the VP's pet project. Ideas are evaluated on merit rather than rank.
            </p>
            <p className="text-slate-300 leading-relaxed mb-4">
              <strong className="text-white">In communities,</strong> participation in town halls and forums is often limited to a small, familiar group while most residents never participate. Union Chant lowers the barrier. People can join from their phones, contribute ideas on their own time, and participate in small group discussions at their convenience. More voices lead to better decisions.
            </p>
            <p className="text-slate-300 leading-relaxed">
              <strong className="text-white">In governance,</strong> citizens often feel disconnected from policy decisions between elections. Voting every few years for representatives is not the same as having a voice. Union Chant can supplement representative systems by enabling large-scale public deliberation on specific issues—giving citizens a structured way to deliberate and surface genuine collective preferences without requiring continuous engagement.
            </p>
          </section>

          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-white mb-4">Addressing Common Concerns</h2>
            <p className="text-slate-300 leading-relaxed mb-4">
              <strong className="text-white">Some worry that this process will take forever.</strong> Because discussions happen in parallel, large decisions can complete in a small number of rounds. In practice, processes involving thousands of participants can conclude in days rather than months. And unlike rushed votes, the outcome actually reflects deliberation.
            </p>
            <p className="text-slate-300 leading-relaxed mb-4">
              <strong className="text-white">Others ask what happens if participation drops off.</strong> The system is designed to handle partial participation gracefully. Early rounds emphasize broad inclusion, while later rounds focus on ideas that have already been widely vetted. If someone can't make one round, they can rejoin later. The process adapts.
            </p>
            <p className="text-slate-300 leading-relaxed mb-4">
              <strong className="text-white">Some raise concerns about bad actors or trolls.</strong> Small groups reduce the effectiveness of disruption. It's hard to troll effectively when you're one of five people in a discussion, and others can see your contributions. Persistent bad-faith behavior is harder to sustain when participants are visible to one another and discussion is structured.
            </p>
            <p className="text-slate-300 leading-relaxed">
              <strong className="text-white">A common question is whether this is just another voting system.</strong> It's fundamentally different. Traditional voting asks people to choose between fixed options in a single moment. Union Chant lets people generate the options, deliberate on them, and refine collective understanding across multiple rounds. It's not just counting preferences. It's building shared understanding.
            </p>
          </section>

          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-white mb-4">An Invitation</h2>
            <p className="text-slate-300 leading-relaxed mb-4">
            ...
            <p className="text-slate-300 leading-relaxed font-medium text-white text-xl">
          ...
          <div className="text-center">
            <Link
              href="/demo"
              className="inline-block bg-purple-600 hover:bg-purple-700 text-white px-8 py-3 rounded-lg font-semibold transition-colors mr-4"
            >
              Watch Demo
            </Link>
            <Link
