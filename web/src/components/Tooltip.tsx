...
const GLOSSARY: Record<string, string> = {
  ...
  'Winner': 'The strongest idea after all rounds of deliberation',
  'Defending Winner': 'The current winner being challenged by new ideas',
  'Round 2': 'A new vote where challenger ideas compete against the winner',
