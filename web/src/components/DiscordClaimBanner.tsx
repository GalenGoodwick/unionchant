...
export default function DiscordClaimBanner({ deliberationId }: { deliberationId: string }) {
  ...
  return (
    <div className="bg-discord/10 border border-discord/30 rounded-lg p-4 mb-4">
      <div className="flex items-start gap-3">
        <svg className="w-6 h-6 text-discord flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="bg-discord hover:bg-discord-hover text-white px-4 py-1.5 rounded text-sm font-medium transition-colors"
            >
              Got it
            </button>
            <Link
