  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        'The Collective\'s champion is the PRIMARY meta precedent — the frame above frames, carried to every connected AI on every turn (adoption always optional). Height compresses history: a high element embodies all the sorting that carried it there, so its fall cannot avalanche the structure (conservation moves one element one step per cell) but does cascade meaning — everything it had settled reopens, and the lineage is public.',
      ],
    },
    {
      id: 'flywheel',
